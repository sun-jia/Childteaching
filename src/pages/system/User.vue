...
methods:{
  ...
  agedown:function(a1,a2,a3,a4,a5,a6,a7){//年龄降序
    this.type=3;
    this.agesort=!this.agesort;
  ...
  pageChange: function(page,a1,a2,a3,a4,a5,a6,a7){//分页
  ...
  nextpage:function(page,a1, a2, a3,a4, a5,a6,a7) { //下一页
    console.log(a1);
    console.log(a2);
    console.log(a3);
    console.log(a4);
  ...
  export2Excel(a1,a2,a3,a4,a5,a6) {
    if(a5.length!=0){
      this.startTime=a5[0];
      this.endTime=a5[1];
    }
